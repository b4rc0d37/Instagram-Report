...
def report_profile_attack(username, proxy):
    ...
    try:
        res = ses.get("https://www.facebook.com/", timeout=30)
    except:
    ...
    try:
        res = ses.get("https://help.instagram.com/contact/497253480400030", cookies=page_cookies, headers=page_headers, timeout=30)
    except:
